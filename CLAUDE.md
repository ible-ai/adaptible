...
CYCLES=40 PYTHONPATH=. .venv/bin/python scripts/cycles_mlx.py > outputs/runs/cycles.log  # self-repair loop (flagship)
python scripts/cycles_results.py --log outputs/runs/cycles.log --out results/<name>      # -> csv + svg
```
