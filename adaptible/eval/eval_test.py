...
harness = adaptible.eval.harness
meta = adaptible.eval.meta
TrainingStats = llm.TrainingStats
...
class FakeModel:
    ...
    Args:
        ...
        train_losses: Per-step correction loss script every training call
            ...
            through ``llm.run_training_steps`` exactly as the real model does,
        ...
        rehearsal_losses: Per-step mean rehearsal loss script for
            ...
            stop rule, exactly as in ``llm.run_joint_training_steps``.
        ...
        rehearsal_margin: Hinge margin the fake applies to its scripted mean
            rehearsal loss, exactly as ``llm.active_rehearsal`` does with the
