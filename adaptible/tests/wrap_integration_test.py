...
ADAPTIBLE_TEST_OLLAMA_MODEL=qwen2.5:0.5b python -m unittest adaptible.tests.wrap_integration_test -v
ADAPTIBLE_TEST_LLAMA_GGUF=/path/model.gguf python -m unittest adaptible.tests.wrap_integration_test -v
ADAPTIBLE_TEST_LM_STUDIO_GGUF=/path/model.gguf python -m unittest adaptible.tests.wrap_integration_test -v
ADAPTIBLE_TEST_VLLM_MODEL=/path/hf-checkpoint python -m unittest adaptible.tests.wrap_integration_test -v
