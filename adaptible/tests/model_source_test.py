...
from adaptible._src.wrap.model_source import fingerprint_base, inspect_base
...
class DirectGGUFSourceTest(unittest.TestCase):
    def test_worker_loads_original_gguf_without_creating_source_link(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                mock.patch(
                    "adaptible._src.wrap.train.inspect_base",
                    return_value="qwen3",
                ),
                mock.patch("adaptible._src.wrap.train.load_tokenizer"),
                mock.patch.object(
