...
class TinyAdapterTest(unittest.TestCase):
    def test_train_restore_and_checkpoint_without_a_download(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            with mock.patch.object(_llm, "_load", return_value=(base, tokenizer)):
            ...
            saved = mx.load(str(Path(directory) / _llm.ADAPTER_FILE))
            ...
            base.load_weights(str(Path(directory) / _llm.ADAPTER_FILE), strict=False)
