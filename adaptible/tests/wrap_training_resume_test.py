...
class ThinkingResumeTest(unittest.TestCase):
    ...
    def save_first(self):
        ...
        from adaptible._src.wrap.training_resume import save_resume
    ...
    def test_uninterrupted_and_resumed_weights_and_all_moments_match(self):
        ...
        from adaptible._src.wrap.training_resume import load_manifest, restore_optimizer
    ...
    def test_identity_rejects_data_options_source_and_parent_changes(self):
        from adaptible._src.wrap.training_resume import load_manifest
    ...
    def test_malformed_or_nonfinite_moments_and_hyperparameters_are_rejected(self):
        from adaptible._src.wrap.training_resume import restore_optimizer
